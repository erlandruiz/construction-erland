...
const Button = ({ text }) => {
  return (
    <button className="w-[210px] h-[54px] py-[5px] pl-[10px] pr-[5px] flex items-center justify-between min-w-[200px] group-[] bgaccent ">
      <div className="flex-1 text-center tracking-[1.2px] font-primary font-bold textprimary text-sm uppercase ">
        {text}
      </div>
      <div className="w-11 h-11 bgprimary flex items-center justify-center">
